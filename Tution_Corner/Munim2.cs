...
{
    public partial class Munim2 : Form
    {
        ...
        private void Munim2_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into guardian_details values(@fname,@lname,@phone,@password,@email,@gender,@location,@image)";
